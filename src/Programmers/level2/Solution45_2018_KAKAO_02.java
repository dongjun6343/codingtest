...
/**
 * [캐시]
 * 지도개발팀에서 근무하는 제이지는 지도에서
 * 도시 이름을 검색하면 해당 도시와 관련된 맛집 게시물들을 데이터베이스에서 읽어 보여주는 서비스를 개발하고 있다.
 ...
 */
class Solution45_2018_KAKAO_02 {

    public static void main(String[] args) {
        Solution45_2018_KAKAO_02 s = new Solution45_2018_KAKAO_02();
        System.out.println(s.solution(3,new String[]{"Jeju", "Pangyo", "Seoul", "NewYork", "LA",
