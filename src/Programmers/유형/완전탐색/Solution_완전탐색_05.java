...
class Solution_완전탐색_05 {
    public static void main(String[] args) {
        Solution_완전탐색_05 s = new Solution_완전탐색_05();
        System.out.println(s.solution(8, 1));
    }
    ...
    public int[] solution(int brown, int yellow) {
        ...
        for (int i = 3; i < sum; i++) {
            ...
            if (sum % i == 0 && j >= 3) {
                ...
                // 약수를 구한 후
                // 가로의 길이가 세로보다 길거나 같은 수
                // yellow의 개수만큼 노란색 격자가 가운데에 위치할 수 있는지 확인. (가로 - 2) * (세로 - 2 ) = yellow의 개수
